...
static const char qt_meta_stringdata_GamePLay[] = {
    "GamePLay\0"
};
...
const QMetaObjectExtraData GamePLay::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject GamePLay::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_GamePLay,
      qt_meta_data_GamePLay, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &GamePLay::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_GamePLay))
        return static_cast<void*>(const_cast< GamePLay*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< GamePLay*>(this));
